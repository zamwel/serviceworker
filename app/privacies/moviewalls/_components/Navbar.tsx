    ...
    >
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-2.5 font-extrabold text-xl">
          <span className="relative grid place-items-center w-9 h-9 rounded-xl overflow-hidden shadow-[0_0_20px_rgba(220,38,38,0.5)] ring-1 ring-white/10">
            <Image src={BRAND.logo} alt={`${BRAND.name} logo`} fill sizes="36px" className="object-cover" priority />
          </span>
