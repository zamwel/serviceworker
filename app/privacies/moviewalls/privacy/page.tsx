        ...
        <main className="space-y-16 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                { title: "Account Information", desc: "If you purchase or restore Pro, your store account handles billing. No account is required to browse or download." },
                { title: "Usage Data", desc: "Favorites and search filters stored locally on your device to power your personal collection." },
          ...
          <section className="bg-gradient-to-br from-red-600/10 to-transparent p-10 rounded-[40px] border border-red-500/10">
            ...
            <ul className="grid gap-4 list-none">
              {[
                ...
                "To remember your favorites and filter preferences",
          ...
          <section>
            ...
            <p className="mb-6">
              Most of your data, including favorites and downloaded wallpapers, lives on
              your device and is removed when you uninstall the app or clear its data. You
              can clear your favorites at any time from the app. To request deletion of any
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-4">
              {["Google Play Billing", "RevenueCat", "Google AdMob", "TMDB API"].map((service) => (
