...
export const userregister = async (userdata: { email: string, password: string, username: string, deviceInfo: string, location: string }) => {
    try {
        const { email, password, username, deviceInfo, location } = userdata;
